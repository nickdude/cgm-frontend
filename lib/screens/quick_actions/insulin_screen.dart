...
class _InsulinScreenState extends State<InsulinScreen> {
  ...
  String _insulinTime = '08-03 17:28';
  static const int _maxTextLength = 150;
  final int _maxImages = 150;
  final ImagePicker _picker = ImagePicker();
  final List<String> _imagePaths = [];

  int get _textCount => _insulinNameController.text.length;
  ...
  @override
  void dispose() {
    _insulinNameController.removeListener(_onTextChanged);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Insulin Name and Photos in one card
              Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(16),
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Please enter the injection information',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: quickActionProvider.isLoading
                    ...
                    final payload = {
                      'actionTime': DateTimeUtils.parseDisplayTimeToIso(_insulinTime),
                      'insulinName': _insulinNameController.text.trim(),
                    };

                    final success = await context.read<QuickActionProvider>().saveInsulin(
                      userId,
                      payload,
                      _imagePaths,
                    );
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Insulin saved successfully!')),
                    );
